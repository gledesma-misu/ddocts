                                    ...
                                    <table id="zero_config" class="table table-report sm:mt-2">
                                            ...
                                            <?php if(is_array($staff_details)&&(count($staff_details)))
                                                ...
                                                <tr class="intro-x">
                                                    ...
                                                    <td class="text-center"><?php $date = $staff_details['dd_date_encoded'];  
                                                    $datepicker = date("M-d-Y h:i A", strtotime($date)); ?>
                                                    <?php echo $datepicker; ?></td>
                                                    <td class="table-report__action w-56">

                                                        <div class="flex justify-center items-center">
                                                            <a class="btn btn-sm btn-outline-primary w-24 inline-block" href="javascript:;" data-toggle="modal" data-target="#Recieve<?php echo $staff_details['dd_id']; ?>"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Receive </a> &nbsp; | &nbsp;<a class="btn btn-sm btn-outline-danger w-24 inline-block"  href="javascript:;" data-toggle="modal" data-target="#Disregard<?php echo $staff_details['dd_id']; ?>"> <i data-feather="trash-2" class="w-4 h-4 mr-1"></i> Disregard </a>
                            ...
                            <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3 xxl:mt-8">
                                ...
                                <div class="mt-5">
                                    <?php foreach($limit_docs as $limit_doc): ?>
                                        ...
                                        <a href="javascript:;" data-toggle="modal" data-target="#View<?php echo $limit_doc['dd_id']; ?>"><div class="intro-x">
                            ...
                            <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3">
                                ...
                                <div class="report-timeline mt-5 relative">
                                    <?php foreach($limit_docs as $limit_doc): ?>
                                        ...
                                        ?>
                                    <?php if ($limit_doc['dd_disregard_doc'] == 1 && $date_end <= $this->session->userdata('last_login')): ?>
                                        <div class="intro-x relative flex items-center mb-3">
                                            <div class="report-timeline__image">
                                                <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                                    <img alt="Rubick Tailwind HTML Admin Template" src="<?php echo base_url('assets/template/images/doc_icon.png'); ?>">
...
$(document).ready(function () {
    ...
    Swal.fire(
      'SUCCESSFUL',
      'Welcome '+name+' this is CWC-DDocTS version 1.0',
      'success'
    )
});
</script>
