...
<html lang="en">
   ...
   <table valign="top" cellspacing="0" width="800" style="table-layout: fixed; border: none; width: 100%;;margin-top: -60px;">
    ...
    <h3 style="text-align: center; font-family: Arial, Helvetica, sans-serif; font-weight: 400;margin-bottom: 30px;"> Council for the Welfare of Children </h3>
   ...
   <?php     }
    ...
    <table cellspacing="0" class="bottom_text">
        <tbody>
            <tr>
                <td style="padding: 10px;"> <?php echo $division; ?></td>
