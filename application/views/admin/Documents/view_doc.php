    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 lg:col-span-4 xxl:col-span-3 flex lg:block flex-col-reverse">
            ...
            <div class="intro-y grid grid-cols-12 gap-3 sm:gap-6 mt-3">
                ...
                <?php
                $i = 0;
                if ($doc_details['dd_filename'] == '|No Uploaded Files!|' || $doc_details['dd_filename'] == '') :
                                    ...
                                    <div class="border-l-2 border-theme-6 pl-4 text-gray-600 mt-2">
                                        <div class="alert alert-secondary show mb-2" role="alert">
                                            <div class="flex items-center">
                                                <div class="font-small text-lg">No Conversation and Action found!</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="report-timeline mt-9 relative">
                                        <div class="intro-x relative flex items-center mb-3">
                                            ...
                                            <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                                ...
                                                <a href="javascript:;" data-toggle="modal" data-target="#Action_Message<?php echo $doc_reply['id']; ?>" class="tooltip" title="View this Conversation!">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-12">
                            <label for="editorDocAction" class="form-label"> Notes / Remarks </label>
                            <textarea placeholder="Enter Notes / Remarks" id="editorDocAction" name="editorDocAction" class="form-control"></textarea>
                        </div>
                    </div>
                    <!-- END: Modal Body -->
                    <!-- BEGIN: Modal Footer -->
...
<div id="header-footer-modal" class="p-5">
    <div class="preview">
        ...
        <div id="Reply_Message" class="modal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <?php echo form_open_multipart('admin/Documents/viewDoc_reply_notes/' . $doc_details['dd_id'], ['id' => 'replyForm']); ?>
                    <!-- BEGIN: Modal Header -->
                    <div class="modal-header">
                        <h2 class="font-medium text-base mr-auto">
                            Reply Message
