    ...
    <div class="content">
        <div class="intro-y flex items-center mt-8">
         ...
         <div class="intro-y box p-5 mt-5">
                ...
                <?php foreach($all_historys as $all_history): ?>
                    <div class="alert alert-secondary show mb-2" role="alert">
                        <div class="flex items-center">
                            <div class="font-medium text-lg">Name : 
                                <?php foreach($staffs as $staff): ?>
                                    <?php if ($all_history['dh_doc_id'] == $staff['staff_id']): ?>
                        ...
                        <div class="mt-3">Action : <?php echo $all_history['dh_action']; ?></div>
                    </div>
                <?php endforeach; ?>
                </div>
