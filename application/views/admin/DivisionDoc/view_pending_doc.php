            ...
            <div class="dropdown-menu w-40">
                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                    ...
                    <div id="pdf" class="modal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <?php echo form_open('admin/DivisionDoc/generate_pdf'); ?>
                                <!-- BEGIN: Modal Header -->
                    ...
                    <div id="excel" class="modal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <?php echo form_open('admin/DivisionDoc/generate_excel'); ?>
                                <!-- BEGIN: Modal Header -->
                                <div class="modal-header">
                                ...
                                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="get_my_staff" class="form-label"> Select Division </label>
                                        <select data-search="true" id="source_doc_excel" name="source_doc_excel" class="tail-select w-full form-control">
                                            <optgroup label="Please Select Division">
                                                <option value="2">Policy Planning and Research Division</option>
                                                <option value="3">Localization and Institutionalization Division</option>
                                                <option value="4">Management Information System Unit</option>
                                    ...
                                    <div class="col-span-12 sm:col-span-6"> <label for="modal-datepicker-1" class="form-label">From</label> <input type="date" id="modal-datepicker-1" name="date_from_excel" class="form-control" data-single-mode="true"> </div>
                                    <div class="col-span-12 sm:col-span-6"> <label for="modal-datepicker-2" class="form-label">To</label> <input type="date" id="modal-datepicker-2" name="date_to_excel" class="form-control" data-single-mode="true"> </div>
                                </div> <!-- END: Modal Body -->
                                <!-- BEGIN: Modal Footer -->
                                <div class="modal-footer text-right"> <button type="button" data-dismiss="modal" class="btn btn-outline-secondary w-20 mr-1">Cancel</button> <button type="submit" class="btn btn-primary w-20">Submit</button> </div> <!-- END: Modal Footer -->
                                <?php echo form_close(); ?>
