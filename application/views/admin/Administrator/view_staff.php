                        ...
                        <tr class="intro-x">
                            ...
                            <td class="text-center">
                                <?php foreach ($staff_divs as $staff_div): ?>
                                    <?php if ($staff_div['sd_code'] == $staff_division['division']) : ?>
                                        <?php echo $staff_div['sd_name']; ?>
                                    <?php endif ?>
                                   
                                <?php endforeach; ?>
                            </td>
                            <!-- $staff_division['division']; ?></td> -->
                                                    ...
                                                    <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                                                        ...
                                                        <div class="col-span-12 sm:col-span-12">
                                                            ...
                                                            <select data-search="true" id="division" name="division" class="tail-select w-full form-control" required>
                                                                <?php foreach ($staff_divs as $staff_div): ?>
                                                                    <?php if ($staff_div['sd_code'] == $staff_division['division']) : ?>
                                                                        <option value="<?php echo $staff_div['sd_code']; ?>" selected><?php echo $staff_div['sd_name']; ?></option>
                                                                    <?php endif ?>
...
<?php if ($this->session->flashdata('s_updated')): ?>
    <script type="text/javascript">
        Swal.fire({
            ...
            icon: 'success',
            html: '<?php echo $this->session->flashdata('s_updated'); ?>',
...
<?php if ($this->session->flashdata('s_remove')): ?>
    <script type="text/javascript">
        Swal.fire({
            title: '<strong>SUCCESSFUL!</strong>',
            icon: 'success',
            html: '<?php echo $this->session->flashdata('s_remove'); ?>',
            showCloseButton: true,
            focusConfirm: true,
            allowEscapeKey: true,
            confirmButtonText: '<i class="fa fa-thumbs-up"></i> GREAT!',
